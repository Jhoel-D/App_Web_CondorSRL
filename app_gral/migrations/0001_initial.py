    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_pedido', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app_gral.pedido')),
                ('id_producto', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app_gral.productoinventario')),
            ],
        ),
        migrations.CreateModel(
            name='OrdenCarritoPedido',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_producto', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app_gral.productoinventario')),
                ('id_venta', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app_gral.ventas')),
            ],
        ),
    ]
